...
function M.setup_legacy_commands(instance)
  ...
  vim.api.nvim_create_user_command('TSCRestart', function()
    vim.notify(
      'TSCRestart is deprecated. Use :TSCStop followed by :TSC instead.',
      vim.log.levels.WARN
    )
    instance:stop()
  ...
  vim.api.nvim_create_user_command('TSCWatch', function()
    vim.notify(
      'TSCWatch is deprecated. Use :TSC watch or configure watch mode in setup().',
      vim.log.levels.WARN
    )
  ...
  vim.api.nvim_create_user_command('TSCClear', function()
    vim.notify(
      'TSCClear is deprecated. Use :TSCClose or configure auto_close in quickfix plugin.',
      vim.log.levels.WARN
    )
